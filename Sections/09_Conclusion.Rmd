...
Estimates are based on a model fit using my assembly of the most comprehensive data set of lodgepole pine flowering available to date, spanning 259 provenances grown at 7 sites and observed over 15 years.
